...
/**
 * Initialises WebGL and creates the 3D scene(初始化WebGL并创建3D场景).
 */
function loadScene() {
  ...
  //    Create a shader program(创建着色程序).
  ...
  //     Create the perspective matrix. The OpenGL function that's normally used for this(创建透视图矩阵。通常使用的OpenGL函数),
  ...
  //     Create the modelview matrix(创建视图模块矩阵)
